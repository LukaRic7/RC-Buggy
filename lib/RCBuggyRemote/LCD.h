...
public:
  ...
  void update()
  {
    ...
    formatTelemetry(
      rpm, kmh, temperature, corner, acceleration, pitch, roll,
      wattage, batteryPct, frontVib, backVib, text
    );
  ...
  void setData(
      ...
      float newBatteryPct, uint8_t newFrontVib, uint8_t newBackVib
  ) {
    rpm = newRpm;
    kmh = newKmh;
...
private:
  ...
  void loadCustomChars() {
    ...
    static const byte bitmaps[8][8] = {
      { 0b00010, 0b00110, 0b01110, 0b11110, 0b01110, 0b00110, 0b00010, 0b00000 }, // CORNER_G
      { 0b00100, 0b01110, 0b10101, 0b00100, 0b00100, 0b00100, 0b00100, 0b00100 }, // STRAIGHT_G
      { 0b00100, 0b01110, 0b10101, 0b00100, 0b00100, 0b10101, 0b01110, 0b00100 }, // PITCH
      { 0b00100, 0b01000, 0b10000, 0b01100, 0b00110, 0b00001, 0b00010, 0b00100 }, // ROLL
      { 0b10001, 0b11111, 0b10001, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000 }, // FRONT_VIBRATION
      { 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b10001, 0b11111, 0b10001 }, // BACK_VIBRATION
      { 0b00011, 0b00110, 0b01100, 0b11111, 0b00110, 0b01100, 0b11000, 0b00000 }, // WATTAGE
      { 0b01110, 0b11111, 0b10001, 0b10101, 0b10101, 0b10101, 0b10001, 0b11111 }  // BATTERY
    };
  ...
  void formatTelemetry(
    ...
    float pitch, float roll, float wattage, float batteryPct, uint8_t frontVib,
    uint8_t backVib, TelemetryText &text
  ) {
